...
# NOTE: By using FROM keyword, we're performing multi stage build.
...
# Expose port 3001 in docker container.
EXPOSE 3001
...
# This code make sure that we run RabbitMQ first before the consumer connects to it.
