...
docker build --target dev -t order_build-service:v1 .
...
docker tag order_build-service:v1 ghcr.io/anthonycreates2000/order_build-service:v1
...
docker push ghcr.io/anthonycreates2000/order_build-service:v1