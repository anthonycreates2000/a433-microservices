...
docker build -t anthony_max/karsajobs-ui:latest  .
...
docker tag anthony_max/karsajobs-ui:latest ghcr.io/maxzx3000/anthony_max/karsajobs-ui:latest
...
docker push ghcr.io/maxzx3000/anthony_max/karsajobs-ui:latest